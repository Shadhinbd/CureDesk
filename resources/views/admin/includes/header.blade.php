...
<div class="header">
	...
	<div class="header-left">
		<a href="{{route('dashboard')}}" class="logo">
			<span class="logo-wordmark">Cure<span>Desk</span></span>
		</a>
	...
	<!-- Global Search -->
	<div class="clinic-searchbar">
		<i class="fe fe-search"></i>
		<input type="text" placeholder="Search products, sales, suppliers...">
	</div>
	<!-- /Global Search -->
	...
	<ul class="nav user-menu">
		...
		<li class="nav-item dropdown has-arrow">
			<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
				<span class="user-img"><img class="rounded-circle" src="{{!empty(auth()->user()->avatar) ? asset('storage/users/'.auth()->user()->avatar): asset('assets/img/avatar.png')}}" width="31" height="31" alt="avatar"></span>
			</a>
