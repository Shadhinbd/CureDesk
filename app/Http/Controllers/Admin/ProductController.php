        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($products)
                ...
                ->filterColumn('product', function($query, $keyword) {
                    $query->whereHas('purchase', function($purchaseQuery) use ($keyword) {
                ...
                ->addColumn('quantity',function($product){
                    if(!empty($product->purchase)){
                        ...
                        if($qty <= 0){
                            return '<span class="badge badge-danger">'.$qty.' &middot; Out of stock</span>';
                        }elseif($qty <= 10){
                            return '<span class="badge badge-warning">'.$qty.' &middot; Low stock</span>';
                        }
                        return '<span class="badge badge-success">'.$qty.' &middot; In stock</span>';
                    }
                })
                ->addColumn('expiry_date',function($product){
                    if(!empty($product->purchase)){
                        $expiry = $product->purchase->expiry_date;
                        $formatted = date_format(date_create($expiry),'d M, Y');
    ...
    public function expired(Request $request){
        ...
        if($request->ajax()){
            ...
            return DataTables::of($products)
                ...
                ->addColumn('expiry_date',function($product){
                    if(!empty($product->purchase)){
                        $formatted = date_format(date_create($product->purchase->expiry_date),'d M, Y');
                        return '<span class="badge badge-danger">'.$formatted.'</span>';
                    }
                })
                ->addColumn('action', function ($row) {
    ...
    public function outstock(Request $request){
        ...
        if($request->ajax()){
            ...
            return DataTables::of($products)
                ...
                ->addColumn('quantity',function($product){
                    if(!empty($product->purchase)){
                        return '<span class="badge badge-danger">'.$product->purchase->quantity.' &middot; Out of stock</span>';
                    }
                })
                ->addColumn('expiry_date',function($product){
                    if(!empty($product->purchase)){
